...
mod test {
    ...
    pub struct TestItem {
        name: String,
        cmd: crate::cmd_router::SubCommand,
        stdin: String,
        want_out: String,
        want_err: String,
    }
    ...
    async fn test_cmd_router() {
        let tests: Vec<TestItem> = vec![
            ...
            TestItem {
                ...
                stdin: "".to_string(),
                want_out: "".to_string(),
                want_err: "[router] required in non-interactive mode".to_string(),
            },
            TestItem {
            ...
            TestItem {
                ...
                cmd: crate::cmd_router::SubCommand::Delete(crate::cmd_router::CmdRouterDelete {
                    router: "things".to_string(),
                    organization: "".to_string(),
                    project: "".to_string(),
            ...
            TestItem {
                ...
                cmd: crate::cmd_router::SubCommand::List(crate::cmd_router::CmdRouterList {
        ...
        for t in tests {
            ...
            match cmd_router.run(&mut ctx).await {
                Ok(()) => {
