...
mod test {
    ...
    pub struct TestItem {
        name: String,
        cmd: crate::cmd_route::SubCommand,
        stdin: String,
        want_out: String,
        want_err: String,
    }
    ...
    async fn test_cmd_route() {
        let destination = Some(oxide_api::types::RouteDestination::Ip("127.0.0.1".to_string()));
        let target = Some(oxide_api::types::RouteTarget::Ip("192.1.16.2".to_string()));
        ...
        let tests: Vec<TestItem> = vec![
            ...
            TestItem {
                ...
                stdin: "".to_string(),
                want_out: "".to_string(),
                want_err: "[route] required in non-interactive mode".to_string(),
            },
            TestItem {
            ...
            TestItem {
                ...
                stdin: "".to_string(),
                want_out: "".to_string(),
                want_err: "-r|--router required in non-interactive mode".to_string(),
            },
            TestItem {
                ...
                stdin: "".to_string(),
                want_out: "".to_string(),
                want_err: "-t|--target required in non-interactive mode".to_string(),
            },
            TestItem {
                ...
                stdin: "".to_string(),
                want_out: "".to_string(),
                want_err: "--destination required in non-interactive mode".to_string(),
            },
            TestItem {
                name: "delete no --confirm non-interactive".to_string(),
                cmd: crate::cmd_route::SubCommand::Delete(crate::cmd_route::CmdRouteDelete {
                    route: "things".to_string(),
                    organization: "".to_string(),
                    project: "".to_string(),
            ...
            TestItem {
                ...
                cmd: crate::cmd_route::SubCommand::List(crate::cmd_route::CmdRouteList {
