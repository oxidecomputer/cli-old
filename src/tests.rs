  ...
  "id": ""#
        ...
        TestItem {
            ...
            args: vec![
                ...
                "--target".to_string(),
                "inetgw=255.255.255.0".to_string(),
        ...
        TestItem {
            ...
            want_out: "description   | My route for testing".to_string(),
            want_err: "".to_string(),
            want_code: 0,
            ..Default::default()
        },
        ...
        TestItem {
            ...
            want_out: r#"| my-route |                My route with new description for testing"#.to_string(),
            want_err: "".to_string(),
            want_code: 0,
            ..Default::default()
        },
